 ...
 * to use threads. The number of cores is specified as an optional parameter.
 * The target problem is Sphere.
 *
...
public class StandardPSO2011Runner {
    ...
    /**
     * Usage: java org.uma.jmetal.runner.singleobjective.StandardPSO2007Runner
     * [cores]
     */
    public static void main(String[] args) throws Exception {
        ...
        String problemName = "org.uma.jmetal.problem.singleobjective.Griewank";
        ...
        for (int i = 1; i <= 30; i++) {
            algorithm = new StandardPSO2011(problem, 50, 100, 3, evaluator);
            ...
            fitnes += String.valueOf(solution.getObjective(0)) + "\n";
            //JMetalLogger.logger.info("Solution: " + solution.getVariableValueString(0));
            evaluator.shutdown();
        }
        
        System.out.println("Fitnnes");
